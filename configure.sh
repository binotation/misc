...
(cd "$HOME"/Downloads && curl -OL https://github.com/neovim/neovim/releases/download/v0.11.0/nvim-linux64.tar.gz && tar xzf nvim-linux64.tar.gz && cp -r nvim-linux64/* "$HOME"/.local)
