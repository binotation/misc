...
(cd "$HOME"/Downloads && curl -OL https://github.com/neovim/neovim/releases/download/v0.11.0/nvim-linux-x86_64.tar.gz && tar xzf nvim-linux-x86_64.tar.gz && cp -r nvim-linux-x86_64/* "$HOME"/.local)
